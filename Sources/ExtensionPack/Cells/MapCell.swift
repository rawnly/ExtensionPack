...
public class MapCell: ThemedTableCell {
    ...
    public func addPin(title: String, subTitle: String, coords coordinates: CLLocationCoordinate2D) {
    ...
    public func addPin(title: String, coords coordinates: CLLocationCoordinate2D) {
