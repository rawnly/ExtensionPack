...
public extension UIColor {
    ...
    @available(iOS 13, *)
    convenience init(light lightColor: String, dark darkColor: UIColor) {
        self.init(light: UIColor(lightColor), dark: darkColor)
    }
    
    @available(iOS 13, *)
    convenience init(light lightColor: UIColor, dark darkColor: String) {
        self.init(light: lightColor, dark: UIColor(darkColor))
    }
    
    @available(iOS 13, *)
    convenience init(light lightColor: String, dark darkColor: String) {
        self.init(light: UIColor(lightColor), dark: UIColor(darkColor))
    }
    
    @available(iOS 13, *)
    convenience init(light lightColor: UIColor, dark darkColor: UIColor) {
